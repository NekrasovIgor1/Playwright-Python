...
# search by titles category
@pytest.mark.usefixtures("setup_page_class")

class TestSearchByTitlesCategory(BaseTest):
    def test_search_by_titles_category(self):
        self.perform_login()
        # search by titles category
        category_text = 'Titles'
        search_text = "Kill Bill"
        ...
        # verify that the selected search category is 'Titles'
