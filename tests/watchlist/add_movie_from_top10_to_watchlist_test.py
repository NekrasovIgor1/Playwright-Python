...
# add video from main page - "top10 on imdb this week" section ,to watchlist
@pytest.mark.usefixtures("setup_page_class")

class TestAddMovieFromTop10ToWatchlist(BaseTest):
    def test_add_movie_from_top10_to_watchlist(self):
        self.perform_login()
        # add the first movie (index 1) from the Top 10 section to the watchlist,
        # and get the movie title for validation
        movie_name_added = self.main_page.add_movie_to_watchlist_by_index_from_top10(3)
